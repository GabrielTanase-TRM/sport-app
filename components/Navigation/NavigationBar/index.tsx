...
export const Navigation = () => {
  ...
  return (
    <div
      className={`fixed lg:flex bg-lightBackground dark:bg-darkSecondaryBackground transition-translate duration-500 ease-out -translate-x-full lg:translate-x-0 z-50 h-full pb-10 lg:py-10 flex flex-col items-center justify-between shadow-xl border-r border-divider dark:border-gray-800 ${
